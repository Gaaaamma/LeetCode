...
int main(int argc, char* argv[]) {
    Solution solution;
    vector<vector<int>> input{{4,2,7,1,3,6,9}, {2,1,3}, {1,null,2}, {1}, 
    {0,1,null,3,null,null,null,7,null,null,null,null,null,null,null,15}, {}};

    for (int i = 0; i < input.size(); i++) {
        output(solution.inorderTraversal(solution.createBT(input[i])));
        output(solution.inorderTraversal(solution.invertTree(solution.createBT(input[i]))));
        cout << "\n";
    }
}